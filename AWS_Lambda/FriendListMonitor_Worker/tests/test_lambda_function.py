...
class TestApp:
    def test_invoke(self, mocker: MockerFixture):
        ...
        friend_1 = src.lambda_function.entity.FriendInfo("user_id_1", "user_name_1", "user_display_name_1", 0, 0)
        friend_2 = src.lambda_function.entity.FriendInfo("user_id_2", "user_name_2", "user_display_name_2", 0, 0)
        friend_3 = src.lambda_function.entity.FriendInfo("user_id_3", "user_name_3", "user_display_name_3", 0, 0)
...
def test_extract_change_friends():
    ...
    inf_old = [
        entity.FriendInfo("user_id_1", "user_name_1", "user_display_name_1", None, dat_old),
        entity.FriendInfo("user_id_2", "user_name_2", "user_display_name_2", None, dat_old),
        entity.FriendInfo("user_id_3", "user_name_3", "user_display_name_3", None, dat_old),
    ]
    dat_new = datetime(2022, 11, 5, 12, 34, 56)
    inf_new = [
        entity.FriendInfo("user_id_1", "user_name_1", "user_display_name_1", None, dat_new),
        entity.FriendInfo("user_id_2", "user_name_2 (更新)", "user_display_name_2 (更新)", None, dat_new),
        entity.FriendInfo("user_id_4", "user_name_4", "user_display_name_4", None, dat_new),
    ]
